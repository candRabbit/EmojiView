...
import cn.com.lv.library.emoji.EmojiCallBackListener;
import cn.com.lv.library.widget.AppCommentView;
...
public class MainActivity extends AppCompatActivity implements EmojiCallBackListener {
    ...
    public void emojiText(String emojiText) {
        ...
        appCommentView.insertEmoji(emojiText);
    }

    @Override
    public void delete() {

        appCommentView.deleteEmoji();
    }
}
